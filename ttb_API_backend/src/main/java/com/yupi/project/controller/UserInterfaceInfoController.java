...
public class UserInterfaceInfoController {
    ...
    public BaseResponse<Long> addUserInterfaceInfo(@RequestBody UserInterfaceInfoAddRequest userInterfaceInfoAddRequest, HttpServletRequest request) {
        ...
        long newUserUserInterfaceInfoId = userInterfaceInfo.getId();
        return ResultUtils.success(newUserUserInterfaceInfoId);
    }
    ...
    public BaseResponse<Boolean> deleteUserInterfaceInfo(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // 判断是否存在
        UserInterfaceInfo oldUserUserInterfaceInfo = userInterfaceInfoService.getById(id);
        if (oldUserUserInterfaceInfo == null) {
            throw new BusinessException(ErrorCode.NOT_FOUND_ERROR);
        }
        // 仅本人或管理员可删除
        if (!oldUserUserInterfaceInfo.getUserId().equals(user.getId()) && !userService.isAdmin(request)) {
